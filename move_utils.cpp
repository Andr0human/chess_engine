...
void decode_move(const int move) {
...
inline void add_cap_moves(const int ip, uint64_t endSquares, const int base_move,
    ...
    const auto encode_full_move = [] (const int base, const int fp,
                                 const int cpt, const int move_pr) {
...
inline void add_quiet_moves(uint64_t endSquares, const int base_move,
                            const chessBoard &_cb, MoveList &myMoves) {
